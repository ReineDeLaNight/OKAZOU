...
function afficherArticles() {
    ...
    $req = $bdd -> prepare("SELECT A.id, A.nom, A.description, A.lien, A.prix, A.couleur, A.etat, A.photo1, A.photo2, A.photo3, T.taille, T.categorie, C.nom_categorie, S.logo, M.marque FROM article A
